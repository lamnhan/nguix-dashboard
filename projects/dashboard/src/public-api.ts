...
export * from './lib/parts/bundle/bundle.service';
...
export * from './lib/pages/media/media.component';
export * from './lib/pages/media/media.module';
export * from './lib/pages/user/user.component';
export * from './lib/pages/user/user.module';
